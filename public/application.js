...
var findProducts = function findProducts() {
  return $.ajax({
    method: 'GET',
...
var onSignUp = function onSignUp(event) {
  ...
  console.log(data);
  api.signUp(data).then(ui.createSuccess).catch(ui.createFail);
};
...
var onNewProduct = function onNewProduct(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createProduct(data).then(ui.createProductSuccess).catch();
};
...
var onUpdateProduct = function onUpdateProduct(event) {
  ...
  var data = getFormFields(event.target);
  api.updateProduct(id, data).then(ui.updateSuccess).catch();
};

var onDeleteProduct = function onDeleteProduct(event) {
  event.preventDefault();
  var id = event.target.getAttribute('data-id');
  api.deleteProduct(id).then(ui.deleteSuccess).catch();
};

var onChangePassword = function onChangePassword(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.changePassword(data).then(ui.changeSuccess).catch(ui.changeFail);
};
...
var signInSuccess = function signInSuccess(response) {
  ...
  api.findProducts().then(showProducts);
...
var showProducts = function showProducts(response) {
  $('.products').html(' ');
  if (response.products.length === 0) {
    $('.products').html('You dont have anything yet! Press the plus button on top to add a new product to your inventory!');
  } else {
    var _showProducts = handlebars({ products: response.products });
    $('.products').append(_showProducts);
  }
};
...
var changeFail = function changeFail(resposne) {
  $('.modal').modal('hide');
  $('#change-PW input').val('');
  $('.alerts').html(' ');
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <div class=\"card\" style=\"width: 20rem;\">\n        <img class=\"card-img-top\" src="
    ...
    + "\">\n          <h5 class=\"card-title\">Item Name: <b>"
    ...
    + "</b></li>\n          <li>Sell Price: <b>$"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.sell_price : stack1), depth0))
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"><span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"></button>\n        <div class=\"modal fade \" id=\"update"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalCenterTitle\" aria-hidden=\"true\">\n          <div class=\"modal-dialog modal-dialog-centered\" role=\"document\">\n            <div class=\"modal-content\">\n              <div class=\"modal-header\">\n                <h3 class=\"modal-title\">Update Product Description</h3>\n              </div>\n              <div class=\"modal-body\">\n\n                <form class=\"update-product\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n                  <div class=\"form-group col-xs-6 col-sm-6\">\n                    <label>Item Name</label>\n                    <input type=\"text\" class=\"form-control\" name=\"product[name]\" placeholder=\"ex: Yeezy 350 V2\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\" required>\n                  </div>\n                  <div class=\"form-group col-xs-6 col-sm- 6\">\n                    <label>Brand</label>\n                    <input type=\"text\" class=\"form-control\" name=\"product[brand]\" placeholder=\"ex: Supreme, Adidas, etc.\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.brand : stack1), depth0))
    + "\" required>\n                  </div>\n                  <div class=\"form-group col-xs-3 col-sm-3\">\n                    <label>Category</label>\n                    <select class=\"form-control\" name=\"product[category]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.category : stack1), depth0))
    + "\" required>\n                  <option value=\"T-shirt\">T-shirt</option>\n                  <option value=\"Shirts\">Shirts</option>\n                  <option value=\"Jacket\">Jacket</option>\n                  <option value=\"Sweater\">Sweater</option>\n                  <option value=\"Pants\">Pants</option>\n                  <option value=\"Sweatshirt\">Sweatshirt</option>\n                  <option value=\"Shorts\">Shorts</option>\n                  <option value=\"Accessories\">Accessories</option>\n                  <option value=\"Hats\">Hats</option>\n                  <option value=\"Bags\">Bags</option>\n                  <option value=\"Shoes\">Shoes</option>\n                  <option value=\"Skates\">Skates</option>\n                </select>\n                  </div>\n                  <div class=\"form-group col-xs-3 col-sm- 3\">\n                    <label>Size</label>\n                    <input type=\"text\" class=\"form-control\" name=\"product[size]\" placeholder=\"ex: (Shirts) S, M, (Shoes) Size 10, Size 13, (Pants) 29, 30, 31\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.size : stack1), depth0))
    + "\" required>\n                  </div>\n                  <div class=\"form-group col-xs-3 col-sm-3\">\n                    <label>Price</label>\n                    <input type=\"text\" class=\"form-control\" name=\"product[sell_price]\" placeholder=\"In USD, without $ sign \" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.sell_price : stack1), depth0))
    + "\" required>\n                  </div>\n                  <div class=\"form-group col-xs-3 col-sm-3\">\n                    <label>Color</label>\n                    <input type=\"text\" class=\"form-control\" name=\"product[color]\" placeholder=\"Red, Blue, etc\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.color : stack1), depth0))
    + "\" required>\n                  </div>\n                  <div class=\"form-group col-xs-6 col-sm-6\">\n                    <label>Picture URL</label>\n                    <input type=\"text\" class=\"form-control\" name=\"product[picture_url]\" placeholder=\"ex: https://stockx-360.imgix.net/Adidas-Yeezy-Boost-350-V2-Butter/Images/Adidas-Yeezy-Boost-350-V2-Butter/Lv2/img36.jpg?auto=format,compress&w=1117&q=90\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.picture_url : stack1), depth0))
    + "\" required>\n                  </div>\n                <div class=\"modal-footer\">\n                  <button type=\"button\" class=\"btn btn-secondary\" data-dismiss=\"modal\"><span class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></span></button>\n                  <button type=\"submit\" class=\"btn btn-success\"><span class=\"glyphicon glyphicon-save\" aria-hidden=\"true\"></span></button>\n                </div>\n                </form>\n              </div>\n            </div>\n          </div>\n        </div>\n        </div>\n      </div>\n";
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://salty-wave-53150.herokuapp.com',
...
module.exports = __webpack_require__.p + "2b69b235be88fca3a22a91d178674f9e.woff";

/***/ }),
/* 41 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "7e4e653548f06c895e05df110d05a1f3.ttf";
